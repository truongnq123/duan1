...
<div class="add-new">
  ...
  <div class="product">
    ...
    <form action="index.php?act=addkh" method="post" enctype="multipart/form-data">
      <div class="hoten">
        <h4>Họ và Tên</h4>
        <input type="text" placeholder="Nhap ho va ten user" name="name">
      </div>
      <div class="img_user">
        <h4>Ảnh</h4>
      ...
      <div class="hoten">
        <h4>Email</h4>
        <input type="email" placeholder="Nhap Email user" name="email">
      </div>
      <div class="Vị Trí">
        <input type="radio" name="role" id="" value="0">Khách Hàng
      <input type="radio" name="role" id="" value="1">Quản lí
      </div>
      <div class="Trạng Thái">
        <input type="radio" name="status" id="" value="Kích Hoạt" >Kích Hoạt
        <input type="radio" name="status" id="Chưa Kích Hoạt">Chưa Kích Hoạt
      </div>
